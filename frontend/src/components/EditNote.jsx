...
const handleUpdateNote = async () => {
    ...
    try {
        const response = await axios.put(
            `http://localhost:3001/updateNote/${formData.id}`,
            formData
        );
...
const handleAdd = () => {
    setModalOpen(
       true,
     <ModalConfirmation onClose = {onClose} handleAccept={handleUpdateNote} title={"Update"} message={"Are you sure you want to edit this note?"} typeOfOption={"Update"} /> ,
   500
    );
};
    return (
                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            ...
                            <div className="relative">
                                ...
                                className="peer resize-none placeholder-transparent h-32 w-full border border-gray-300 text-gray-900 focus:outline-none focus:border-rose-600 mb-4 p-2"></textarea>
                                ...
                                <div className="relative flex justify-between">
                                    ...
                                    type='submit'
                                    onClick={handleAdd}
                                    className="bg-blue-500 text-white rounded-md px-2 py-1">Accept</button>
                                     <button 
                                     onClick={onCloseUpdate}
                                     className="bg-red-500 text-white rounded-md px-2 py-1">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
